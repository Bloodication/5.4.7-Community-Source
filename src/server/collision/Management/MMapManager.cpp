...
namespace MMAP
{
    ...
    bool MMapManager::loadMapData(uint32 mapId)
    {
        ...
        if (!file)
        {
            sLog->outError(LOG_FILTER_MAPS,"MMAP:loadMapData: Error: Could not open mmap file '%s'", fileName);
            delete [] fileName;
            return false;
        }
		...
		sLog->outError(LOG_FILTER_MAPS, "MMAP:loadMapData: Loaded %03i.mmap", mapId);
    ...
    ACE_RW_Thread_Mutex& MMapManager::GetMMapLock(uint32 mapId)
    {
        ...
        if (!map)
        {
			sLog->outError(LOG_FILTER_MAPS, "ZOMG! MoveMaps: BaseMap not found!");
    ...
    bool MMapManager::loadMap(uint32 mapId, int32 x, int32 y)
    {
        ...
        {
			sLog->outError(LOG_FILTER_MAPS, "MMAP:loadMap: Asked to load already loaded navmesh tile. %03u%02i%02i.mmtile", mapId, x, y);
            return false;
        }
        ...
        if (!file)
        {
			sLog->outError(LOG_FILTER_MAPS, "MMAP:loadMap: Could not open mmtile file '%s'", fileName);
            delete [] fileName;
            return false;
        }
        delete [] fileName;
        ...
        if (stat == DT_SUCCESS)
        {
            ...
            ++loadedTiles;
			sLog->outError(LOG_FILTER_MAPS, "MMAP:loadMap: Loaded mmtile %03i[%02i,%02i] into %03i[%02i,%02i]", mapId, x, y, mapId, header->x, header->y);
            return true;
        }
        else
        {
    ...
    bool MMapManager::unloadMap(uint32 mapId, int32 x, int32 y)
    {
        ...
        if (loadedMMaps.find(mapId) == loadedMMaps.end())
        {
			...
			sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMap: Asked to unload not loaded navmesh map. %03u%02i%02i.mmtile", mapId, x, y);
            return false;
        }
        ...
        {
            // file may not exist, therefore not loaded
			sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMap: Asked to unload not loaded navmesh tile. %03u%02i%02i.mmtile", mapId, x, y);
            return false;
        }
        ...
        else
        {
            ...
            --loadedTiles;
			; sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMap: Unloaded mmtile %03i[%02i,%02i] from %03i", mapId, x, y, mapId);
            return true;
        }
    ...
    bool MMapManager::unloadMap(uint32 mapId)
    {
        ...
        {
            // file may not exist, therefore not loaded
			sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMap: Asked to unload not loaded navmesh map %03u", mapId);
            return false;
        }
		...
		sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMap: Unloaded %03i.mmap", mapId);
    ...
    bool MMapManager::unloadMapInstance(uint32 mapId, uint32 instanceId)
    {
        ...
        {
            // file may not exist, therefore not loaded
			sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMapInstance: Asked to unload not loaded navmesh map %03u", mapId);
            return false;
        }
        ...
        {
			sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMapInstance: Asked to unload not loaded dtNavMeshQuery mapId %03u instanceId %u", mapId, instanceId);
            return false;
        }
		...
		sLog->outError(LOG_FILTER_MAPS, "MMAP:unloadMapInstance: Unloaded mapId %03u instanceId %u", mapId, instanceId);
    ...
    dtNavMeshQuery const* MMapManager::GetNavMeshQuery(uint32 mapId, uint32 instanceId)
    {
        ...
        if (mmap->navMeshQueries.find(instanceId) == mmap->navMeshQueries.end())
        {
			...
			sLog->outError(LOG_FILTER_MAPS, "MMAP:GetNavMeshQuery: created dtNavMeshQuery for mapId %03u instanceId %u", mapId, instanceId);
