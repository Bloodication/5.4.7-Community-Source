...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "start",          SEC_REALM_LEADER ,  false, &HandleBattlefieldStart,            "", NULL },
            { "stop",           SEC_REALM_LEADER ,  false, &HandleBattlefieldEnd,              "", NULL },
            { "switch",         SEC_REALM_LEADER ,  false, &HandleBattlefieldSwitch,           "", NULL },
            { "timer",          SEC_REALM_LEADER ,  false, &HandleBattlefieldTimer,            "", NULL },
            { "enable",         SEC_REALM_LEADER ,  false, &HandleBattlefieldEnable,           "", NULL },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "bf",             SEC_REALM_LEADER ,  false, NULL,            "", battlefieldcommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
