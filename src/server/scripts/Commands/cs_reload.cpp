...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "achievement", SEC_REALM_LEADER,  true,  &HandleReloadAllAchievementCommand, "", NULL },
            { "area",       SEC_REALM_LEADER,  true,  &HandleReloadAllAreaCommand,       "", NULL },
            { "gossips",    SEC_REALM_LEADER,  true,  &HandleReloadAllGossipsCommand,    "", NULL },
            { "item",       SEC_REALM_LEADER,  true,  &HandleReloadAllItemCommand,       "", NULL },
            { "locales",    SEC_REALM_LEADER,  true,  &HandleReloadAllLocalesCommand,    "", NULL },
            { "loot",       SEC_REALM_LEADER,  true,  &HandleReloadAllLootCommand,       "", NULL },
            { "npc",        SEC_REALM_LEADER,  true,  &HandleReloadAllNpcCommand,        "", NULL },
            { "quest",      SEC_REALM_LEADER,  true,  &HandleReloadAllQuestCommand,      "", NULL },
            { "scripts",    SEC_REALM_LEADER,  true,  &HandleReloadAllScriptsCommand,    "", NULL },
            { "spell",      SEC_REALM_LEADER,  true,  &HandleReloadAllSpellCommand,      "", NULL },
            { "",           SEC_REALM_LEADER,  true,  &HandleReloadAllCommand,           "", NULL },
            { NULL,         0,                  false, NULL,                              "", NULL }
        };
        static ChatCommand reloadCommandTable[] =
        {
            { "auctions",                     SEC_REALM_LEADER, true,  &HandleReloadAuctionsCommand,                   "", NULL },
            { "access_requirement",           SEC_REALM_LEADER, true,  &HandleReloadAccessRequirementCommand,          "", NULL },
            { "lfr_access_requirement",       SEC_REALM_LEADER, true,  &HandleReloadLFRAccessRequirementCommand,       "", NULL },
            { "lfg_entrances",                SEC_REALM_LEADER, true,  &HandleReloadLFGEntrancesCommand,               "", NULL },
            { "achievement_criteria_data",    SEC_REALM_LEADER, true,  &HandleReloadAchievementCriteriaDataCommand,    "", NULL },
            { "achievement_reward",           SEC_REALM_LEADER, true,  &HandleReloadAchievementRewardCommand,          "", NULL },
            { "all",                          SEC_REALM_LEADER, true,  NULL,                          "", reloadAllCommandTable },
            { "area_skip_update",             SEC_REALM_LEADER, true,  &HandleReloadAreaSkipUpdateCommand,             "", NULL },
            { "areatrigger_involvedrelation", SEC_REALM_LEADER, true,  &HandleReloadQuestAreaTriggersCommand,          "", NULL },
            { "areatrigger_tavern",           SEC_REALM_LEADER, true,  &HandleReloadAreaTriggerTavernCommand,          "", NULL },
            { "areatrigger_teleport",         SEC_REALM_LEADER, true,  &HandleReloadAreaTriggerTeleportCommand,        "", NULL },
            { "autobroadcast",                SEC_REALM_LEADER, true,  &HandleReloadAutobroadcastCommand,              "", NULL },
            { "command",                      SEC_REALM_LEADER, true,  &HandleReloadCommandCommand,                    "", NULL },
            { "conditions",                   SEC_REALM_LEADER, true,  &HandleReloadConditions,                        "", NULL },
            { "config",                       SEC_REALM_LEADER, true,  &HandleReloadConfigCommand,                     "", NULL },
            { "creature_area",                SEC_REALM_LEADER, true,  &HandleReloadCreatureArea,                      "", NULL },
            { "creature_text",                SEC_REALM_LEADER, true,  &HandleReloadCreatureText,                      "", NULL },
            { "creature_involvedrelation",    SEC_REALM_LEADER, true,  &HandleReloadCreatureQuestInvRelationsCommand,  "", NULL },
            { "creature_linked_respawn",      SEC_REALM_LEADER,    true,  &HandleReloadLinkedRespawnCommand,              "", NULL },
            { "creature_loot_template",       SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesCreatureCommand,      "", NULL },
            { "creature_onkill_reputation",   SEC_REALM_LEADER, true,  &HandleReloadOnKillReputationCommand,           "", NULL },
            { "creature_questrelation",       SEC_REALM_LEADER, true,  &HandleReloadCreatureQuestRelationsCommand,     "", NULL },
            { "creature_template",            SEC_REALM_LEADER, true,  &HandleReloadCreatureTemplateCommand,           "", NULL },
            //{ "db_script_string",             SEC_REALM_LEADER, true,  &HandleReloadDbScriptStringCommand,            "", NULL },
            { "disables",                     SEC_REALM_LEADER, true,  &HandleReloadDisablesCommand,                   "", NULL },
            { "disenchant_loot_template",     SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesDisenchantCommand,    "", NULL },
            { "event_scripts",                SEC_REALM_LEADER, true,  &HandleReloadEventScriptsCommand,               "", NULL },
            { "fishing_loot_template",        SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesFishingCommand,       "", NULL },
            { "game_graveyard_zone",          SEC_REALM_LEADER, true,  &HandleReloadGameGraveyardZoneCommand,          "", NULL },
            { "game_tele",                    SEC_REALM_LEADER, true,  &HandleReloadGameTeleCommand,                   "", NULL },
            { "gameobject_involvedrelation",  SEC_REALM_LEADER, true,  &HandleReloadGOQuestInvRelationsCommand,        "", NULL },
            { "gameobject_loot_template",     SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesGameobjectCommand,    "", NULL },
            { "gameobject_questrelation",     SEC_REALM_LEADER, true,  &HandleReloadGOQuestRelationsCommand,           "", NULL },
            { "gameobject_scripts",           SEC_REALM_LEADER, true,  &HandleReloadGameObjectScriptsCommand,          "", NULL },
            { "gm_tickets",                   SEC_REALM_LEADER, true,  &HandleReloadGMTicketsCommand,                  "", NULL },
            { "gossip_menu",                  SEC_REALM_LEADER, true,  &HandleReloadGossipMenuCommand,                 "", NULL },
            { "gossip_menu_option",           SEC_REALM_LEADER, true,  &HandleReloadGossipMenuOptionCommand,           "", NULL },
            { "guild_rewards",                SEC_REALM_LEADER, true,  &HandleReloadGuildRewardsCommand,               "", NULL },
            { "item_enchantment_template",    SEC_REALM_LEADER, true,  &HandleReloadItemEnchantementsCommand,          "", NULL },
            { "item_loot_template",           SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesItemCommand,          "", NULL },
            { "lfg_dungeon_rewards",          SEC_REALM_LEADER, true,  &HandleReloadLfgRewardsCommand,                 "", NULL },
            { "locales_achievement_reward",   SEC_REALM_LEADER, true,  &HandleReloadLocalesAchievementRewardCommand,   "", NULL },
            { "locales_creature",             SEC_REALM_LEADER, true,  &HandleReloadLocalesCreatureCommand,            "", NULL },
            { "locales_creature_text",        SEC_REALM_LEADER, true,  &HandleReloadLocalesCreatureTextCommand,        "", NULL },
            { "locales_gameobject",           SEC_REALM_LEADER, true,  &HandleReloadLocalesGameobjectCommand,          "", NULL },
            { "locales_gossip_menu_option",   SEC_REALM_LEADER, true,  &HandleReloadLocalesGossipMenuOptionCommand,    "", NULL },
            { "locales_item",                 SEC_REALM_LEADER, true,  &HandleReloadLocalesItemCommand,                "", NULL },
            { "locales_npc_text",             SEC_REALM_LEADER, true,  &HandleReloadLocalesNpcTextCommand,             "", NULL },
            { "locales_page_text",            SEC_REALM_LEADER, true,  &HandleReloadLocalesPageTextCommand,            "", NULL },
            { "locales_points_of_interest",   SEC_REALM_LEADER, true,  &HandleReloadLocalesPointsOfInterestCommand,    "", NULL },
            { "locales_quest",                SEC_REALM_LEADER, true,  &HandleReloadLocalesQuestCommand,               "", NULL },
            { "mail_level_reward",            SEC_REALM_LEADER, true,  &HandleReloadMailLevelRewardCommand,            "", NULL },
            { "mail_loot_template",           SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesMailCommand,          "", NULL },
            { "milling_loot_template",        SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesMillingCommand,       "", NULL },
            { "npc_spellclick_spells",        SEC_REALM_LEADER, true,  &HandleReloadSpellClickSpellsCommand,           "", NULL},
            { "npc_trainer",                  SEC_REALM_LEADER, true,  &HandleReloadNpcTrainerCommand,                 "", NULL },
            { "npc_vendor",                   SEC_REALM_LEADER, true,  &HandleReloadNpcVendorCommand,                  "", NULL },
            { "page_text",                    SEC_REALM_LEADER, true,  &HandleReloadPageTextsCommand,                  "", NULL },
            { "phasedefinitions",             SEC_REALM_LEADER, true,  &HandleReloadPhaseDefinitionsCommand,           "", NULL },
            { "pickpocketing_loot_template",  SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesPickpocketingCommand, "", NULL},
            { "points_of_interest",           SEC_REALM_LEADER, true,  &HandleReloadPointsOfInterestCommand,           "", NULL },
            { "prospecting_loot_template",    SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesProspectingCommand,   "", NULL },
            { "quest_end_scripts",            SEC_REALM_LEADER, true,  &HandleReloadQuestEndScriptsCommand,            "", NULL },
            { "quest_poi",                    SEC_REALM_LEADER, true,  &HandleReloadQuestPOICommand,                   "", NULL },
            { "quest_start_scripts",          SEC_REALM_LEADER, true,  &HandleReloadQuestStartScriptsCommand,          "", NULL },
            { "quest_template",               SEC_REALM_LEADER, true,  &HandleReloadQuestTemplateCommand,              "", NULL },
            { "reference_loot_template",      SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesReferenceCommand,     "", NULL },
            { "reserved_name",                SEC_REALM_LEADER, true,  &HandleReloadReservedNameCommand,               "", NULL },
            { "reputation_reward_rate",       SEC_REALM_LEADER, true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "reputation_spillover_template", SEC_REALM_LEADER, true,  &HandleReloadReputationRewardRateCommand,       "", NULL },
            { "script_waypoint",              SEC_REALM_LEADER, true,  &HandleReloadScriptWaypointCommand,             "", NULL },
            { "skill_discovery_template",     SEC_REALM_LEADER, true,  &HandleReloadSkillDiscoveryTemplateCommand,     "", NULL },
            { "skill_extra_item_template",    SEC_REALM_LEADER, true,  &HandleReloadSkillExtraItemTemplateCommand,     "", NULL },
            { "skill_fishing_base_level",     SEC_REALM_LEADER, true,  &HandleReloadSkillFishingBaseLevelCommand,      "", NULL },
            { "skinning_loot_template",       SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesSkinningCommand,      "", NULL },
            { "smart_scripts",                SEC_REALM_LEADER, true,  &HandleReloadSmartScripts,                      "", NULL },
            { "spell_required",               SEC_REALM_LEADER, true,  &HandleReloadSpellRequiredCommand,              "", NULL },
            { "spell_area",                   SEC_REALM_LEADER, true,  &HandleReloadSpellAreaCommand,                  "", NULL },
            { "spell_bonus_data",             SEC_REALM_LEADER, true,  &HandleReloadSpellBonusesCommand,               "", NULL },
            { "spell_group",                  SEC_REALM_LEADER, true,  &HandleReloadSpellGroupsCommand,                "", NULL },
            { "spell_learn_spell",            SEC_REALM_LEADER, true,  &HandleReloadSpellLearnSpellCommand,            "", NULL },
            { "spell_loot_template",          SEC_REALM_LEADER, true,  &HandleReloadLootTemplatesSpellCommand,         "", NULL },
            { "spell_linked_spell",           SEC_REALM_LEADER, true,  &HandleReloadSpellLinkedSpellCommand,           "", NULL },
            { "spell_pet_auras",              SEC_REALM_LEADER, true,  &HandleReloadSpellPetAurasCommand,              "", NULL },
            { "spell_proc_event",             SEC_REALM_LEADER, true,  &HandleReloadSpellProcEventCommand,             "", NULL },
            { "spell_proc",                   SEC_REALM_LEADER, true,  &HandleReloadSpellProcsCommand,                 "", NULL },
            { "spell_scripts",                SEC_REALM_LEADER, true,  &HandleReloadSpellScriptsCommand,               "", NULL },
            { "spell_target_position",        SEC_REALM_LEADER, true,  &HandleReloadSpellTargetPositionCommand,        "", NULL },
            { "spell_threats",                SEC_REALM_LEADER, true,  &HandleReloadSpellThreatsCommand,               "", NULL },
            { "spell_group_stack_rules",      SEC_REALM_LEADER, true,  &HandleReloadSpellGroupStackRulesCommand,       "", NULL },
            { "trinity_string",               SEC_REALM_LEADER, true,  &HandleReloadTrinityStringCommand,              "", NULL },
            { "warden_action",                SEC_REALM_LEADER, true,  &HandleReloadWardenactionCommand,               "", NULL },
            { "waypoint_scripts",             SEC_REALM_LEADER, true,  &HandleReloadWpScriptsCommand,                  "", NULL },
            { "waypoint_data",                SEC_REALM_LEADER, true,  &HandleReloadWpCommand,                         "", NULL },
            { "vehicle_accessory",            SEC_REALM_LEADER, true,  &HandleReloadVehicleAccessoryCommand,           "", NULL },
            { "vehicle_template_accessory",   SEC_REALM_LEADER, true,  &HandleReloadVehicleTemplateAccessoryCommand,   "", NULL },
            { NULL,                           0,                 false, NULL,                                           "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "reload",         SEC_REALM_LEADER,  true,  NULL,                 "", reloadCommandTable },
            { NULL,             0,                  false, NULL,                               "", NULL }
        };
        return commandTable;
    }
