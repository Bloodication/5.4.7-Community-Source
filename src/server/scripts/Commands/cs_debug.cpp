...
class debug_commandscript : public CommandScript
{
    public:
        ...
        ChatCommand* GetCommands() const
        {
            ...
            {
                { "cinematic",      SEC_REALM_LEADER ,      false, &HandleDebugPlayCinematicCommand,   "", NULL },
                { "movie",          SEC_REALM_LEADER ,      false, &HandleDebugPlayMovieCommand,       "", NULL },
                { "sound",          SEC_REALM_LEADER ,      false, &HandleDebugPlaySoundCommand,       "", NULL },
                { "scene",          SEC_REALM_LEADER ,  false, &HandleDebugPlaySceneCommand,       "", NULL },
                { NULL,             SEC_PLAYER,         false, NULL,                               "", NULL }
            };
            static ChatCommand debugSendCommandTable[] =
            {
                { "buyerror",       SEC_REALM_LEADER ,  false, &HandleDebugSendBuyErrorCommand,       "", NULL },
                { "channelnotify",  SEC_REALM_LEADER ,  false, &HandleDebugSendChannelNotifyCommand,  "", NULL },
                { "chatmmessage",   SEC_REALM_LEADER ,  false, &HandleDebugSendChatMsgCommand,        "", NULL },
                { "equiperror",     SEC_REALM_LEADER ,  false, &HandleDebugSendEquipErrorCommand,     "", NULL },
                { "largepacket",    SEC_REALM_LEADER ,  false, &HandleDebugSendLargePacketCommand,    "", NULL },
                { "opcode",         SEC_REALM_LEADER ,  false, &HandleDebugSendOpcodeCommand,         "", NULL },
                { "qpartymsg",      SEC_REALM_LEADER ,  false, &HandleDebugSendQuestPartyMsgCommand,  "", NULL },
                { "qinvalidmsg",    SEC_REALM_LEADER ,  false, &HandleDebugSendQuestInvalidMsgCommand,"", NULL },
                { "sellerror",      SEC_REALM_LEADER ,  false, &HandleDebugSendSellErrorCommand,      "", NULL },
                { "setphaseshift",  SEC_REALM_LEADER ,  false, &HandleDebugSendSetPhaseShiftCommand,  "", NULL },
                { "spellfail",      SEC_REALM_LEADER ,  false, &HandleDebugSendSpellFailCommand,      "", NULL },
                { NULL,             SEC_PLAYER,         false, NULL,                                  "", NULL }
            };
            static ChatCommand debugCommandTable[] =
            {
                { "setbit",         SEC_REALM_LEADER ,  false, &HandleDebugSet32BitCommand,        "", NULL },
                { "threat",         SEC_REALM_LEADER ,  false, &HandleDebugThreatListCommand,      "", NULL },
                { "hostil",         SEC_REALM_LEADER ,  false, &HandleDebugHostileRefListCommand,  "", NULL },
                { "anim",           SEC_REALM_LEADER ,     false, &HandleDebugAnimCommand,            "", NULL },
                { "arena",          SEC_REALM_LEADER ,  false, &HandleDebugArenaCommand,           "", NULL },
                { "bg",             SEC_REALM_LEADER ,  false, &HandleDebugBattlegroundCommand,    "", NULL },
                { "df",             SEC_REALM_LEADER ,  false, &HandleDebugDungeonFinderCommand,   "", NULL },
                { "getitemstate",   SEC_REALM_LEADER ,  false, &HandleDebugGetItemStateCommand,    "", NULL },
                { "lootrecipient",  SEC_REALM_LEADER ,     false, &HandleDebugGetLootRecipientCommand,"", NULL },
                { "getvalue",       SEC_REALM_LEADER ,  false, &HandleDebugGetValueCommand,        "", NULL },
                { "getitemvalue",   SEC_REALM_LEADER ,  false, &HandleDebugGetItemValueCommand,    "", NULL },
                { "Mod32Value",     SEC_REALM_LEADER ,  false, &HandleDebugMod32ValueCommand,      "", NULL },
                { "play",           SEC_REALM_LEADER ,      false, NULL,              "", debugPlayCommandTable },
                { "send",           SEC_REALM_LEADER ,  false, NULL,              "", debugSendCommandTable },
                { "setaurastate",   SEC_REALM_LEADER ,  false, &HandleDebugSetAuraStateCommand,    "", NULL },
                { "setitemvalue",   SEC_REALM_LEADER ,  false, &HandleDebugSetItemValueCommand,    "", NULL },
                { "setvalue",       SEC_REALM_LEADER ,  false, &HandleDebugSetValueCommand,        "", NULL },
                { "spawnvehicle",   SEC_REALM_LEADER ,  false, &HandleDebugSpawnVehicleCommand,    "", NULL },
                { "setvid",         SEC_REALM_LEADER ,  false, &HandleDebugSetVehicleIdCommand,    "", NULL },
                { "entervehicle",   SEC_REALM_LEADER ,  false, &HandleDebugEnterVehicleCommand,    "", NULL },
                { "uws",            SEC_REALM_LEADER ,  false, &HandleDebugUpdateWorldStateCommand,"", NULL },
                { "update",         SEC_REALM_LEADER ,  false, &HandleDebugUpdateCommand,          "", NULL },
                { "itemexpire",     SEC_REALM_LEADER ,  false, &HandleDebugItemExpireCommand,      "", NULL },
                { "areatriggers",   SEC_REALM_LEADER ,  false, &HandleDebugAreaTriggersCommand,    "", NULL },
                { "los",            SEC_REALM_LEADER ,      false, &HandleDebugLoSCommand,             "", NULL },
                { "moveflags",      SEC_REALM_LEADER ,  false, &HandleDebugMoveflagsCommand,       "", NULL },
                { "phase",          SEC_REALM_LEADER ,      false, &HandleDebugPhaseCommand,           "", NULL },
                { "tradestatus",    SEC_REALM_LEADER ,  false, &HandleSendTradeStatus,             "", NULL },
                { "mailstatus",     SEC_REALM_LEADER ,  false, &HandleSendMailStatus,              "", NULL },
                { "jump",           SEC_REALM_LEADER ,  false, &HandleDebugMoveJump,               "", NULL },
                { "backward",       SEC_REALM_LEADER ,  false, &HandleDebugMoveBackward,           "", NULL },
                { "load_z",         SEC_REALM_LEADER ,  false, &HandleDebugLoadZ,                  "", NULL },
                { "packet",         SEC_REALM_LEADER ,  false, &HandleDebugPacketCommand,          "", NULL },
                { "guildevent",     SEC_REALM_LEADER ,  false, &HandleDebugGuildEventCommand,      "", NULL },
                { "log",            SEC_REALM_LEADER ,  false, &HandleDebugLogCommand,             "", NULL },
                { NULL,             SEC_PLAYER,         false, NULL,                               "", NULL }
            };
            static ChatCommand commandTable[] =
            {
                { "debug",          SEC_REALM_LEADER ,      true,  NULL,                  "", debugCommandTable },
                { "wpgps",          SEC_REALM_LEADER ,  false, &HandleWPGPSCommand,                "", NULL },
                { NULL,             SEC_PLAYER,         false, NULL,                  "",              NULL }
            };
            return commandTable;
        }
