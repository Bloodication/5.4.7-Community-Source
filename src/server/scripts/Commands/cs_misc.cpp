...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "leader",         SEC_REALM_LEADER,          false,  &HandleGroupLeaderCommand,          "", NULL },
            { "disband",        SEC_REALM_LEADER,          false,  &HandleGroupDisbandCommand,         "", NULL },
            { "remove",         SEC_REALM_LEADER,          false,  &HandleGroupRemoveCommand,          "", NULL },
            { NULL,             0,                          false,  NULL,                               "", NULL }
        };
        static ChatCommand petCommandTable[] =
        {
            { "create",             SEC_REALM_LEADER,         false, &HandleCreatePetCommand,             "", NULL },
            { "learn",              SEC_REALM_LEADER,         false, &HandlePetLearnCommand,              "", NULL },
            { "unlearn",            SEC_REALM_LEADER,         false, &HandlePetUnlearnCommand,            "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        static ChatCommand sendCommandTable[] =
        {
            { "items",              SEC_REALM_LEADER,      true,  &HandleSendItemsCommand,             "", NULL },
            { "mail",               SEC_MODERATOR,          true,  &HandleSendMailCommand,              "", NULL },
            { "message",            SEC_REALM_LEADER,      true,  &HandleSendMessageCommand,           "", NULL },
            { "money",              SEC_REALM_LEADER,      true,  &HandleSendMoneyCommand,             "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        static ChatCommand auraCommandTable[] =
        {
            { "duration",           SEC_REALM_LEADER,      true,  &HandleAuraDurationCommand,          "", NULL },
            { "charges",            SEC_REALM_LEADER,      true,  &HandleAuraChargesCommand,           "", NULL },
            { "",                   SEC_REALM_LEADER,      true,  &HandleAuraCommand,                  "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        static ChatCommand commandTable[] =
        {
            { "lfgstatus",          SEC_REALM_LEADER,      false, &HandleLfgStatus,                    "", NULL },
            { "blackmarketwon",     SEC_REALM_LEADER,      false, &HandleBlackMarketWon,               "", NULL },
            { "setarch",            SEC_REALM_LEADER,      false, &HandleSetArchCommand,               "", NULL },
            { "lootroll",           SEC_REALM_LEADER,      false, &HandleSendLootRollCommand,          "", NULL },
            { "startmirror",        SEC_REALM_LEADER,      false, &HandleMirrorTimerStartCommand,      "", NULL },
            { "stopmirror",         SEC_REALM_LEADER,      false, &HandleMirrorTimerStopCommand,       "", NULL },
            { "dev",                SEC_REALM_LEADER,      false, &HandleDevCommand,                   "", NULL },
            { "gps",                SEC_MODERATOR,          false, &HandleGPSCommand,                   "", NULL },
            { "aura",               SEC_REALM_LEADER,      false, NULL,                                "", auraCommandTable },
            { "unaura",             SEC_REALM_LEADER,      false, &HandleUnAuraCommand,                "", NULL },
            ...
            { "die",                SEC_REALM_LEADER,      false, &HandleDieCommand,                   "", NULL },
            { "revive",             SEC_MODERATOR,          true,  &HandleReviveCommand,                "", NULL },
            { "dismount",           SEC_PLAYER,             false, &HandleDismountCommand,              "", NULL },
            { "guid",               SEC_REALM_LEADER,         false, &HandleGUIDCommand,                  "", NULL },
            { "help",               SEC_PLAYER,             true,  &HandleHelpCommand,                  "", NULL },
            { "itemmove",           SEC_REALM_LEADER,         false, &HandleItemMoveCommand,              "", NULL },
            { "cooldown",           SEC_REALM_LEADER,      false, &HandleCooldownCommand,              "", NULL },
            { "distance",           SEC_REALM_LEADER,      false, &HandleGetDistanceCommand,           "", NULL },
            ...
            { "linkgrave",          SEC_REALM_LEADER,      false, &HandleLinkGraveCommand,             "", NULL },
            { "neargrave",          SEC_REALM_LEADER,      false, &HandleNearGraveCommand,             "", NULL },
            { "showarea",           SEC_REALM_LEADER,      false, &HandleShowAreaCommand,              "", NULL },
            { "hidearea",           SEC_REALM_LEADER,      false, &HandleHideAreaCommand,              "", NULL },
            { "additem",            SEC_REALM_LEADER,      false, &HandleAddItemCommand,               "", NULL },
            { "additemset",         SEC_REALM_LEADER,      false, &HandleAddItemSetCommand,            "", NULL },
            { "bank",               SEC_MODERATOR,          false, &HandleBankCommand,                  "", NULL },
            { "wchange",            SEC_REALM_LEADER,      false, &HandleChangeWeather,                "", NULL },
            { "setskill",           SEC_REALM_LEADER,      false, &HandleSetSkillCommand,              "", NULL },
            { "pinfo",              SEC_GAMEMASTER,         true,  &HandlePInfoCommand,                 "", NULL },
            { "respawn",            SEC_REALM_LEADER,      false, &HandleRespawnCommand,               "", NULL },
            { "send",               SEC_MODERATOR,          true,  NULL,                                "", sendCommandTable },
            { "pet",                SEC_REALM_LEADER,         false, NULL,                                "", petCommandTable },
            { "mute",               SEC_MODERATOR,          true,  &HandleMuteCommand,                  "", NULL },
            { "unmute",             SEC_MODERATOR,          true,  &HandleUnmuteCommand,                "", NULL },
            { "movegens",           SEC_REALM_LEADER,      false, &HandleMovegensCommand,              "", NULL },
            { "cometome",           SEC_REALM_LEADER,      false, &HandleComeToMeCommand,              "", NULL },
            { "damage",             SEC_REALM_LEADER,      false, &HandleDamageCommand,                "", NULL },
            { "damagetest",         SEC_REALM_LEADER,      false, &HandleDamageTestCommand,            "", NULL },
            { "mailtest",           SEC_REALM_LEADER,      false, &HandleMailTestCommand,              "", NULL },
            { "combatstop",         SEC_MODERATOR,         true, &HandleCombatStopCommand,             "", NULL },
            { "flusharenapoints",   SEC_CONFIRMED_GAMEMASTER,      false, &HandleFlushArenaPointsCommand,      "", NULL },
            { "repairitems",        SEC_MODERATOR,         true,  &HandleRepairitemsCommand,           "", NULL },
            ...
            { "group",              SEC_REALM_LEADER,      false, NULL,                                "", groupCommandTable },
            { "possess",            SEC_REALM_LEADER,      false, &HandlePossessCommand,               "", NULL },
            { "unpossess",          SEC_REALM_LEADER,      false, &HandleUnPossessCommand,             "", NULL },
            { "bindsight",          SEC_REALM_LEADER,      false, &HandleBindSightCommand,             "", NULL },
            { "unbindsight",        SEC_REALM_LEADER,      false, &HandleUnbindSightCommand,           "", NULL },
            { "playall",            SEC_GAMEMASTER,         false, &HandlePlayAllCommand,               "", NULL },
            { "selectfaction",      SEC_REALM_LEADER,      false, &HandleSelectFactionCommand,         "", NULL },
            { NULL,                 0,                      false, NULL,                                "", NULL }
        };
        return commandTable;
    }
