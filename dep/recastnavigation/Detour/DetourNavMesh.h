...
/// Do not rename back to uint64. Otherwise Mac (XCode) complains about typedef redefinition
...
// Edited by TC
// We cannot have over 31 bits for either tile nor poly without changing polyCount to use 64bits too.
